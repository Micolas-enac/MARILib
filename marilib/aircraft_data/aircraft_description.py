...
class Aircraft(object):
    ...
    def export_to_file(self, filename="Aircraft.ini",
        ...
        """Build  ini file: Data tree file.

        :param filename: Output file path - default value `'Aircraft.ini'`
        :param user_format: parameters value format. Default value True or 4 for 4 decimals format. Disable option with False or -1.
        :param write_unit: Boolean to write the unit after the variables value - default value False
        :param write_om: Boolean to write the order of magnitude as a inline comment - default value False
        :param write_detail: Boolean to write the variables description as a inline comment - default value False
